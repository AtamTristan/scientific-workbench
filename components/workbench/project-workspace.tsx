...
export function ProjectWorkspace() {
  ...
  const strategies = [...new Set(missionRuns.map((run) => run.configuration.strategy).filter((value): value is string => typeof value === "string"))];
  ...
  return <div className={`workspace mode-${snapshot.mode}`}>
    <aside className="work-nav">
      <div className="work-brand"><Image className="work-brand-logo" src="/scientific-platform-mark-64.png" width={38} height={38} alt=""/><span>Scientific<br/><b>Workbench</b><small>PRE-BA RUNTIME · 0.4</small></span></div>
